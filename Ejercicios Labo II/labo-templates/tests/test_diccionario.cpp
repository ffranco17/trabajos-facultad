...
TEST(diccionario, dicc_string_bool){
    ...
    ASSERT_FALSE(d.def("clave1"));
    ASSERT_FALSE(d.def("clave2"));
    ASSERT_FALSE(d.def("clave3"));
    d.definir("clave1", true);
    ASSERT_TRUE(d.def("clave1"));
    ASSERT_FALSE(d.def("clave2"));
    ASSERT_FALSE(d.def("clave3"));
    d.definir("clave2", false);
    ASSERT_TRUE(d.def("clave1"));
    ASSERT_TRUE(d.def("clave2"));
    ASSERT_FALSE(d.def("clave3"));
    d.definir("clave3", true);
    ASSERT_TRUE(d.def("clave1"));
    ASSERT_TRUE(d.def("clave2"));
    ASSERT_TRUE(d.def("clave3"));

    ASSERT_EQ(d.obtener("clave1"), true);
    ASSERT_EQ(d.obtener("clave2"), false);
    ASSERT_EQ(d.obtener("clave3"), true);
